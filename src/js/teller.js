...
[   data-bs-theme="light"] {\
    ...
    <brick id="fatherBrick">\
        <brick id="feedbackBrick">\
            <brick id="mainNotificationBrick">\
                <brick id="titleBrick" loom="How would you describe your experience?">How would you describe your experience?</brick>\
                <brick id="paragraphBrick">Powered by ' + tellerSmallA + '</brick>\
            </brick>\
            <brick id="emojisBrick">\
                <brick id="emojiBrick1">\
                    ...
                    <brick id="emojiDescriptionBrick1" loom="Superb">Superb</brick>\
                </brick>\
                <brick id="emojiBrick2">\
                    ...
                    <brick id="emojiDescriptionBrick2" loom="Good">Good</brick>\
                </brick>\
                <brick id="emojiBrick3">\
                    ...
                    <brick id="emojiDescriptionBrick3" loom="Normal">Normal</brick>\
                </brick>\
                <brick id="emojiBrick4">\
                    ...
                    <brick id="emojiDescriptionBrick4" loom="Bad">Bad</brick>\
                </brick>\
                <brick id="emojiBrick5">\
                    ...
                    <brick id="emojiDescriptionBrick5" loom="Furious">Furious</brick>\
                </brick>\
                <brick id="emojiSelectorBrick"></brick>\
            </brick>\
            <brick id="textAreasBrick">\
                <textarea id="textAreaBrick" placeholder="Share your experience with us." loom-placeholder="Share your experience with us." loom></textarea>\
            </brick>\
                <brick id="inputAreasBrick">\
                    <input id="inputAreaBrick" placeholder="email@example.com" loom-placeholder="email@example.com" loom></input>\
                </brick>\
                <brick id="actionButtonBrick" loom="Next">Next</brick>\
                <brick id="skipButtonBrick" loom="Skip">Skip</brick>\
        ...
        <brick id="whatsappArea">\
            <input id="textAreaWsp" placeholder="Send us a message" loom-placeholder="Send us a message" loom></input>\
            <brick id="wspSendButtonBrick">' + wspSendButtonIcon + '</brick>\
        </brick>\
        <brick id="telegramArea">\
            <input id="textAreaTelegram" placeholder="Join us in Telegram" loom-placeholder="Join us in Telegram" loom></input>\
            <brick id="telegramSendButtonBrick">' + telegramSendButtonIcon + '</brick>\
        </brick>\
        <brick id="messengerArea">\
            <a id="messengerSendButtonBrick" loom="Send us a message">Send us a message' + messengerSendButtonIcon + '</a>\
        </brick>\
    </brick>'
    ...
    function operatorData() {
        ...
        function operatorName() {
            if (n == null || n == "none" || n == "" && u == null || u == "none" || u == "") { return "John Bot"; }
    ...
    function welcomeBubble() {
        ...
        if (a == null || a == "none" || a == "") return "Hello! Give us some feedback.";
        else { return a };
    }
    ...
    function brick() {
        ...
        function userCallToActionMessage() {
            ...
            // has a call to action message by the user
            if (a) {
                // is active (TODO: Add title to hoverbrick to show state is active)
                if (stateGeneral) {
                    hoverBrick.textContent = a
                    hoverBrick.setAttribute('loom', a);
                }
                // is offline
                else {
                    hoverBrick.textContent = a
                ...
                if (stateGeneral) {
                    ...
                    hoverBrick.setAttribute('loom', "Share your user experience with us or send us a message.");
                }
                else {
                    hoverBrick.textContent = "Share your user experience with us or send us a message."
                    hoverBrick.setAttribute('loom', "Share your user experience with us or send us a message.");
        ...
        buttonFatherBrick.addEventListener("click", function () {
            ...
            interacted = true;
            if (displayedBox) {
                tellerTag.classList.remove('teller-launched');
                displayedBox = false;
                //Show father brick
                hmm(fatherBrick)
                ...
                tellerTag.classList.add('teller-launched');
                displayedBox = true;
        ...
        function checkEmail() {
            ...
            if (inputAreaBrick.value == "") {
                ...
                actionButtonBrick.style.color = realWhite;
                actionButtonBrick.style.backgroundColor = nebulaGrey;
                notificationAppear(notificationParagraphBrick, 'This field cannot be empty.');
            }
            else if (!isEmail) {
                emailTeller = "";
                emailReadyTeller = false;
        ...
        function submit(answer) {
            if (lockAndLoudTeller) {
                ...
                if ((navigator.userAgent.indexOf("MSIE") != -1) || (!!document.documentMode == true)) {
                    ...
                    notificationAppear(titleBrick, 'Your browser does not support the request, we will have to redirect it.');
                    ...
                    fetch(fullFeedbackurl, opts).then(function (response) {
                        ...
                        .catch(function (error) {
                            ...
                            notificationAppear(titleBrick, 'Something went wrong, please try later.');
        ...
        actionButtonBrick.addEventListener("click", function () {
            ...
            //Emotion and message completed
                ...
                setTimeout(function () {
                    ...
                    actionButtonBrick.textContent = "Submit";
                    actionButtonBrick.setAttribute('loom', "Submit");
                    actionButtonBrick.style.color = realWhite;
                    actionButtonBrick.style.backgroundColor = nebulaGrey;
